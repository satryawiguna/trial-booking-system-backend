...
async function main() {
  ...
  const bSci1 = await prisma.booking.upsert({
    ...
    create: {
      ...
      trialClassId: '20000000-0000-4000-8000-000000000002',
      status: 'CONFIRMED',
  ...
  await prisma.booking.upsert({
    ...
    create: {
      ...
      studentId: student1.id,
      trialClassId: '20000000-0000-4000-8000-000000000003',
      status: 'CONFIRMED',
  ...
  const bEngPending = await prisma.booking.upsert({
    ...
    create: {
      ...
      trialClassId: '20000000-0000-4000-8000-000000000004',
  ...
  for (let i = 0; i < 4; i++) {
    await prisma.paymentAttempt.upsert({
      where: { id: `60000000-0000-4000-8000-00000000000${4 + i}` },
      update: {},
      create: {
        id: `60000000-0000-4000-8000-00000000000${4 + i}`,
        bookingId: `50000000-0000-4000-8000-00000000000${5 + i}`,
        status: 'SUCCESS',
